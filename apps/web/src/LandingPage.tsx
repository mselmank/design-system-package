    ...
    <div style={pageStyle}>
      ...
      >
        ...
        <RetroHeading
          style={{
            fontSize: "48px",
            marginBottom: "16px",
            textShadow: `4px 4px 0px ${theme.colors.textSecondary}`,
          }}
        >
          BUILD FASTER.
        </RetroHeading>
        ...
        >
          The ultimate retro-styled component library for modern React
          applications. Zero runtime overhead. 100% Type-safe.
        </RetroText>
        ...
        >
          {[
            ...
            <div key={stat.label} style={{ textAlign: "center" }}>
              <RetroHeading style={{ fontSize: "32px", marginBottom: "8px" }}>
                {stat.value}
              </RetroHeading>
              <RetroText style={{ fontSize: "18px", color: "textSecondary" }}>
                {stat.label}
              </RetroText>
            </div>
          ))}
      ...
      >
        <div style={{ animation: "blink 1s step-end infinite" }}>
          <RetroHeading style={{ fontSize: "14px" }}>
